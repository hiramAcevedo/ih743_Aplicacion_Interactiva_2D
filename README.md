...
| 2.2. El primer escenario | Campamento de día y noche, navegación entre escenas y páginas, controles anclados | [act-2.2](https://github.com/hiramAcevedo/ih745_Aplicacion_Interactiva_2D/tree/act-2.2) |
...
- `Assets/Scenes/Escenario.unity`: campamento con dos páginas (actividad 2.2).
